...
#include <time.h>
#include <Arduino.h>
// Pin diagram in ascii for ESP32 C6 Super Mini ESP32-C6FH4
// https://www.aliexpress.com/item/1005007592520291.html
// https://ae01.alicdn.com/kf/S663e135321ca47d9befe3c3e0098f7ffH.jpg
//                   TX  -|O‾‾‾‾‾‾‾‾|- 5
//                   RX  -|  |  |   |- GND
//                   0   -|  B+ B-  |- 3V3
//                   1   -|         |- 20
...
//                   6   -|         |- 9
//                   7   -|_________|- 8
// Has extra pins knowing around. Including 15 as a little LED
// Seems like every pin can do every thing basically, never seen anything like it
// Battery pins underneath! can charge, apparently from USB port too
//
// SPI pins have to be specified
// SPI.begin(6,  // SCK
//           -1, // MISO (not used here, set to -1 if unused)
//           7   // MOSI
// );
//
/*
